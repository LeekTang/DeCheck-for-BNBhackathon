  ...
  <div>
            ...
            <div class="flex justify-between flex-wrap">
              <template v-for="(item, index) in listOrder" :key="index">
                <div v-if="state.goInfo.hasOwnProperty(item.key)"
                  class="w-[33.75rem] flex flex-col border-b-2 border-b-[#FFFFFF1C]">
                  <div class="flex items-center my-[1rem]">
                    <template v-if="item.grade == 1">
                      <img
                        ...
                        class="h-[1.5rem] w-[1.12rem] mr-[0.5rem]">
                    </template>
          ...
          <div class="w-[36.75rem] h-[31.5rem] rounded-[1.25rem] border border-solid border-[#ffffff1c]">
            ...
            <div class="p-[1.5rem] text-[0.88rem]">
              <div class="h-[3.5rem] flex justify-between items-center border-b border-b-[#FFFFFF1C]">
                ...
                <p class="text-[#FFFFFF] font-bold w-[16.12rem]" v-if="state.goInfo.token_symbol">
                  {{ state.goInfo.token_symbol }} ({{ state.goInfo.token_name }})</p>
              ...
              <div class="h-[3.5rem] flex justify-between items-center border-b border-b-[#FFFFFF1C]">
                ...
                <div class="flex items-center text-[#FFFFFF] font-bold w-[16.12rem] cursor-pointer"
              ...
              <div class="h-[3.5rem] flex justify-between items-center">
                ...
                <a :href="store.searchProjectInfo.website" target="_blank">
                  <div
                    class="text-[#FFFFFF] font-bold w-[16.12rem] h-[2rem] px-[1rem] rounded-[0.75rem] bg-[#1E50FFFF] flex items-center justify-between">
          ...
          <div class="w-[36.75rem] h-[31.5rem] rounded-[1.25rem] border border-solid border-[#ffffff1c]">
            ...
            <div class="p-[1.5rem] text-[0.88rem]">
              ...
              <div class="h-[3.5rem] flex justify-between items-center">
                ...
                <div
                  class="text-[#FFFFFF] font-bold w-[16.12rem] h-[2rem] px-[1rem] rounded-[0.75rem] bg-[#1E50FFFF] flex items-center justify-between cursor-pointer">
              ...
              <div class="flex justify-between">
                <div class="h-[17.5rem] w-[16.13rem] bg-[#ffffff1c] rounded-[0.75rem] p-[1rem]">
                  ...
                  <div
                    class="flex justify-center items-center flex-col h-[11.5rem] w-[14.15rem] bg-[#ffffff14] rounded-[0.5rem] my-[1rem]">
    ...
    <client-only>
      <el-dialog v-model="state.dialogVisble" width="587px" align-center :show-close="false">
        ...
        <div class="h-[40px] w-[180px] leading-[40px] mt-[2rem] cursor-pointer text-center
